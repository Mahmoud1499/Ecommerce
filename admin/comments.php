            ...
            <div class="container">
                <div class="table-responsive">
                    ...
                    foreach ($comments as $comment) {
                        ...
                        echo " <td> <a class='btn btn-success' href='comments.php?do=Edit&comid=" . $comment['c_id'] . "'> <i class='fa fa-edit ' > Edit </i> </a>
                                     <a class='btn btn-danger confirm' href='comments.php?do=Delete&comid=" . $comment['c_id'] . "'>  <i class='fa fa-close ' > Delete </i> </a>";
                        if ($comment['status'] == 0) {
                            echo    "<a class='btn btn-info activate' href='comments.php?do=Approve&comid=" . $comment['c_id'] . "'>  <i class='fa fa-check ' > Approve </i> </a>";
                        }
                        echo    "</td>";
                    ...
                    echo '<div class="nice-massage"> There os no Comments to show  </div>';
